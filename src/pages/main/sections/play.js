...
function UpdateServer() {
    ...
    if (userData['servers_info'][modpack_name]['adminrole'] == 'Player')
    {
        document.getElementById('role-par').innerHTML = `${userData['servers_info'][modpack_name]['privilege']}`;
    }
    else
    {
        document.getElementById('role-par').innerHTML = `${userData['servers_info'][modpack_name]['privilege']} < ${userData['servers_info'][modpack_name]['adminrole']} >`;
    }
}
